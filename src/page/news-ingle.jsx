...
import PopularPostNews from "../component/sidebar/popular-post-news";
...
const BlogSingle = () => {
    ...
    return (
        <Fragment>
            <Header />
            <Helmet>
                 <meta name="keywords" content={news.newstag}/>
                 <meta name="description" content={news.newsmetadescription} />
            </Helmet>
            <PageHeader title={news.blogTitle} curPage={'News Details'} />
                                            ...
                                            <div className="post-item style-2">
                                                <div className="post-inner">
                                                    <div className="post-thumb">
                                                         <img src={`${news.newsfeatureimg}`}  className="w-100" alt={news.newstitle} />
                                                        {/* <img src="assets/images/blog/single/01.jpg" alt="blog thumb rajibraj91" /> */}
                                                    </div>
                                                    <div className="post-content">
                                                        <h2>{news.newstitle}</h2>
                                                        <div className="meta-post">
                                                            <ul className="lab-ul">
                                                                <li><a href="#"><i className="icofont-calendar"></i>{news.createdAt?.slice(0,10)}</a></li>
                                                            </ul>
                                                        </div>
                                                        <p><pre>{news.newsdescription}</pre></p>
