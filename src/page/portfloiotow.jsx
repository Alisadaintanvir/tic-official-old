...
//     const filtered = portfoliofilter.map((p) => ({...p,
//       filtered: p.protfoliocat.includes(filter),
//     }));
...
//  useEffect(()=>{
//     const menuItems = [...new Set(portfoliofilter.map((Val) => console.log(Val.protfoliocat)))];
//  },)
                        ...
                        <>
                           <div className="col-md-1 border border-warning d-flex justify-content-center align-items-center mb-3">
                            <Link to={`/portfolio/filter/${cat._id}`} active={filter === "all"} className="">
                             ...
                             {/* <button onClick={()=>handleFilter(cat._id)} >Clicl</button> */}
                        </>
                            ...
                            <article>
                                <div className={`shop-product-wrap row justify-content-center ${GridList ? "grid" : "list"}`} >
                                    ...
                                    portfoliofilter.map((val, i) => (
                                        portfoliofilter ? 
                                       <>
                                        <div className="col-lg-4 col-md-4 col-12 overflow-hidden" key={i}>
                                          ...
                                          <div className="product-item">
                                                <div className="product-thumb">
                                                    ...
                                                    <div className="product-action-link">
                                                        <a href={val.url} target="_blank"><i className="icofont-eye"></i></a>
                                            ...
                                            <div className="product-list-item">
                                                <div className="product-thumb">
                                                    <div className="pro-thumb">
                                                        <img src={`${val.projectimage}`} alt={`${val.imgAlt}`} />
                                                    </div>
                                                    <div className="product-action-link">
