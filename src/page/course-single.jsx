...
const CourseSingle = () => {
    ...
    const [courseDetails, setCourseDeatils] = useState([]);
    const {getCourseBySlug} = courseApi();
    useEffect(()=>{
        getCourseBySlug(slug).then(data=>setCourseDeatils(data))
    },[])
    return (
        <Fragment>
            <Header />
            <PageHeaderTwo courseDetails = {courseDetails}/>
                    ...
                    <div className="row justify-content-center">
                                ...
                                <div className="course-item">
                                    <div className="course-inner">
                                        <div className="course-content">
                                            ...
                                            <p className="text-justify" style={{textAlign: "justify"}}>{courseDetails.coursedescription}</p>
                        ...
                        <div className="col-lg-4">
                            <div className="sidebar-part">
                                <CourseSideDetail courseDetails ={courseDetails}/>
                                {/* <CourseSideCetagory /> */}
                            </div>
                        </div>
                    </div>
