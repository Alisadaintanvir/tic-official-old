...
const BlogSingle = () => {
    ...
    return (
        <Fragment>
            <Header />
            <Helmet>
                 <meta name="keywords" content={blog.blogTags}/>
                 <meta name="description" content={blog.blogmetadescription} />
            </Helmet>
            <PageHeader title={blog.blogTitle} curPage={'Blog Detais'} />
                                            ...
                                            <div className="post-item style-2">
                                                <div className="post-inner">
                                                    <div className="post-thumb">
                                                         <img src={`${API}/blog/thumbnail/${blog._id}`} className="w-100" alt={blog.blogTitle} />
                                                    ...
                                                    <div className="post-content">
                                                        ...
                                                        <div className="meta-post">
                                                            <ul className="lab-ul">
                                                                <li><a href="#"><i className="icofont-calendar"></i>{blog.createdAt?.slice(0,10)}</a></li>
                                                                <li><a href="#"><i className="icofont-ui-user"></i>{blog.blogAuthor}</a></li>
                                                                <li><a href="#"><i className="icofont-speech-comments"></i>09 Comments</a></li>
                                                            </ul>
                                                        </div>
                                                        <p><pre>{blog.blogdescription}</pre></p>
