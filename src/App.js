  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route
          path="service/ecommerce-application"
          element={<EcommereceApp />}
        />
        <Route
          path="service/custom-application"
          element={<CustomApplicaiton />}
        />
        ...
        <Route
          path="service/digital-advertise"
          element={<DigitalAdvertise />}
        />
        <Route path="service/website-maintance" element={<Maintenance />} />
        <Route
          path="service/installation-service"
