              ...
              <div className="menu">
                <ul className={`lab-ul ${menuToggle ? "active" : ""}`}>
                  ...
                  <li className="menu-item-has-children">
                    ...
                    <ul className="lab-ul dropdown-menu">
                      <li>
                        <NavLink to="/service/domain-service">Domain</NavLink>
                        <ul className="lab-ul dropdown-menu">
                          <li>
                            <a
                              href="https://hostnate.com/cart.php?a=add&domain=register"
                              target="_blank"
                            >
                              {" "}
                              Domain Search
                          ...
                          <li>
                            <Link to="">.BD Domain</Link>
                          </li>
                          <li>
                            <Link to="/service/email-server">Email Server</Link>
                          </li>
                          <li>
                            <Link to="/service/dns-service">DNS Service</Link>
                          </li>
                          <li>
                            <Link to="/service/installation-service">
                              Installation Service
                            </Link>
                          </li>
                          <li>
                            <Link to="/service/website-maintance">
                              Website Maintenance
                            </Link>
                          </li>
                        </ul>
                      ...
                      <li>
                        <a href="https://hostnate.com/" target="_blank">
                          Hosting
                        </a>
                        <ul className="lab-ul dropdown-menu">
                          <li>
                            <a
                              href="https://hostnate.com/shared-hosting"
                              target="_blank"
                            >
                              {" "}
                              Shared Hosting
                          ...
                          <li>
                            <a
                              href="https://hostnate.com/premium-hosting"
                              target="_blank"
                            >
                              Premium Hosting
                            </a>
                          ...
                          <li>
                            <a
                              href="https://hostnate.com/reseller-host"
                              target="_blank"
                            >
                              Reseller Hosting
                            </a>
                          ...
                          <li>
                            <a
                              href="https://hostnate.com/wordpress-hosting"
                              target="_blank"
                            >
                              Wordpress Hosting
                            </a>
                          ...
                          <li>
                            <a
                              href="https://hostnate.com/vps-hosting"
                              target="_blank"
                            >
                              VPS Hosting
                            </a>
                      ...
                      <li>
                        <NavLink to="/service/digital-marketing">
                          Digital Marketing
                        </NavLink>
                        <ul className="lab-ul dropdown-menu">
                          <li>
                          ...
                          <li>
                            <Link to="/service/local-seo-service">
                              Local Seo Service
                            </Link>
                          </li>
                        </ul>
                      ...
                      <li>
                        ...
                        <ul className="lab-ul dropdown-menu">
                          <li>
                            <Link to="/service/php-application">
                              PHP Web Application
                            </Link>
                          </li>
                          <li>
                            <Link to="/service/mobile-application">
                              Mobile Web Application
                            </Link>
                          </li>
                          <li>
                            <Link to="/service/ecommerce-application">
                              Ecommerce Web Application
                            </Link>
                          </li>
                          <li>
                            <Link to="/service/custom-application">
                              Custom Web Application
                            </Link>
                          </li>
                          <li>
                            <Link to="/service/erp-application">
                              ERP Web Application
                            </Link>
                          </li>
                        </ul>
                      ...
                      <li>
                        <NavLink to="/service/web-design">Web Design</NavLink>
                        <ul className="lab-ul dropdown-menu">
                          <li>
                            <Link to="/service/webdesign">HTML CSS Design</Link>
                          </li>
                          <li>
                            <Link to="/service/psdtohmtl">
                              Ecommerce Web Design
                            </Link>
                          </li>
                          <li>
                            <Link to="/service/ecommerce-design">
                              PSD TO HTML Conversions
                            </Link>
                          </li>
                          <li>
                            <Link to="/service/website-redesign">
                              Website Redesign
                            </Link>
                          </li>
                          <li>
                            <Link to="/service/blog-webdevelopment">
                              Blog Website Design
                            </Link>
                          </li>
                        </ul>
                      ...
                      <li>
                        <NavLink to="/category/wocmmerce-solutions">
                          Woocommerce Solutions
                        </NavLink>
                      </li>
                      <li>
                        <NavLink to="/category/software-development">
                          Software Development
                        </NavLink>
                      </li>
                      <li>
                        <NavLink to="/category/apps-develoment">
                          Apps Development
                        </NavLink>
                      </li>
                      <li>
                        ...
                        <ul className="lab-ul dropdown-menu">
                          <li>
                            <Link to="/service/logo-design">Logo Design</Link>
                          </li>
                          <li>
                            <Link to="/service/banner-design">
                              Banner Design
                            </Link>
                          </li>
                          <li>
                            <Link to="">Background Removal</Link>
                          </li>
                          <li>
                  ...
                  <li className="menu-item-has-children">
                    ...
                    <ul className="lab-ul dropdown-menu">
                      <li>
                        <Link to="/ecommerce-packages">Ecommerce Packages</Link>
                      </li>
                      <li>
                        <Link to="/woocomerce-packages">
                          Woocommerce Packages
                        </Link>
                      </li>
                      <li>
                        <Link to="/school-college-package">
                          School/College Packages
                        </Link>
                      </li>
                      <li>
                        <Link to="/news-portal-packages">
                          News Portal Packages
                        </Link>
                      </li>
                      <li>
                        <Link to="/ngo-pacakge">Nonprofit/Ngo Packages</Link>
                      </li>
                      <li>
                      ...
                      <li>
                        <Link to="/realstate-packages">
                          Real Estate Package
                        </Link>
                      </li>
                      <li>
                        <Link to="/tour-travel-packages">
                          Tour & Travel Package
                        </Link>
                      </li>
                      <li>
                        <Link to="/corporate-packages">Corporate Package</Link>
                      </li>
                      <li>
                        <Link to="/personal-packages">Personal Website</Link>
                      </li>
                    </ul>
                  </li>
                  {/* <li className="menu-item-has-children">
                  ...
                  <li className="menu-item-has-children">
                    ...
                    <ul className="lab-ul dropdown-menu">
                      <li>
                        <Link to="/addmission">Student Admission</Link>
                      </li>
                      <li>
                        <Link to="/student-feedback">Student Feedback</Link>
                      </li>
                      <li>
                        <Link to="/student-support">Student Support </Link>
                      </li>
                      <li>
                        <Link to="/student">Admission Help</Link>
                      </li>
                    </ul>
                  </li>
                  <li className="menu-item-has-children">
                  ...
                  <li>
                    <NavLink to="/portfolio2">Portfolio</NavLink>
                  </li>
                </ul>
              </div>
